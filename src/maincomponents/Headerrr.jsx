...
function Headerrr() {
    ...
    return (
      ...
      <nav>
        ...
        <div className=" divide-y gap-y-1 divide-solid divide-transparent  bg-opacity-45 mt-8 w-11/12 min-h-24  border-solid  ">                            {/* // diveded */}
              ...
              <div className=' flex  space-x-32 items-center lg:justify-between px-10 bg-[#2b4855]  border-solid rounded-t-xl rounded-r-xl '>                        {/* // up */}
                <div className=''>
                  ...
                  <div className=" flex rounded-md w-full  border-zinc-200 bg-gray-200  max-h-20 px-1 space-x-5   ">
 ...
 {/* //------------------------------------------------------------------------------------------------------------------------------         */}
              ...
              <div className=''>
              <div className='bg-gradient-to-r from-[#4e031757]  to-[#2e414700]  border-l items-center justify-center p-2 rounded-bl-lg ' >                       {/* // down */}
